...
function em_add_options() {
	...
	$dbem_options = array(
		...
		*/
		...
		'dbem_event_list_item_format_header' => '<table align="center" cellpadding="0" cellspacing="0" class="events-table" >
    <thead>
        <tr>
			<th class="event-time" width="500">'.__('Date/Time','dbem').'</th>
